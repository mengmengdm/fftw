...
% ***********TODO TODO TODO TODO***************: 
% 1/ input your directory at line 21
% 2/ uncomment line 57 or 60

% add the path to the release directory of your C code (where the executable is generated)
% Example: dir='C:\temp\fastconvolution\';

dir='path goes here - make sure to end with a back slash';
...
actdir=pwd;
cd(dir)
%%%%%%%%UNCOMMENT THE FOLLOWING LINE IF YOU ARE ON MAC OS OR LINUX%%%%%%%%%%
% ! ./fastconvolution

%%%%%%%%%%%%%%%%UNCOMMENT THE FOLLOWING LINE IF YOU ARE ON WINDOWS%%%%%%%%%
% [status,cmdout] = system('fastconvolution.exe');
